...
Этот проект — **клиентская модификация** (расширение Chrome) и **не связан, не одобрен и не спонсируется** Discord Inc.

### Предупреждение о рисках
Использование сторонних клиентов или расширений, изменяющих веб‑клиент Discord, нарушает [Условия использования Discord](https://discord.com/terms) (в частности, о модификациях клиента и скрейпинге).
- **Используйте на свой риск.**
- Разработчик не несёт ответственности за блокировки, баны или другие санкции со стороны Discord.

### Конфиденциальность и обработка данных
Это расширение отправляет содержимое сообщений в **Cerebras Inference API** для перевода.
- **Поток данных:** Discord Web Client -> Ваш браузер -> Cerebras API -> Ваш браузер.
- **Ваш API‑ключ:** API‑ключ хранится локально (`chrome.storage.local`) и отправляется напрямую в Cerebras. Он не отправляется на другие сторонние серверы.
- **Конфиденциальность:** Используя расширение, вы признаёте, что видимый на экране текст может обрабатываться Cerebras. Подробнее: [Политика конфиденциальности Cerebras](https://cerebras.ai/privacy-policy).
